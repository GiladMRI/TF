...
def np_to_tfrecords(X, Y, file_path_prefix, verbose=True):
    ...
    def _dtype_feature(ndarray):
        ...
        elif dtype_ == np.int8 or dtype_ == np.uint8:
...
xx = np.random.randn(1,218)
xx[0,0]=0.76
xx[0,1]=0.74
xx[0,2]=0.72
yy = np.random.randn(1,1)
...
#xx = np.random.randn(1,116412)
xx = np.zeros((1,116412))
xx[0,0]=0.76
xx[0,1]=0.74
xx[0,2]=0.72
...
np_to_tfrecords(xx1, None, '/home/a/TF/srez/dataset1/a1', verbose=True)
np_to_tfrecords(xx1, None, '/home/a/TF/srez/dataset1/a2', verbose=True)
np_to_tfrecords(xx1, None, '/home/a/TF/srez/dataset1/a3', verbose=True)
np_to_tfrecords(xx1, None, '/home/a/TF/srez/dataset1/a4', verbose=True)
...
# features={'X': tf.FixedLenFeature([], tf.float),  })
# qq=tf.parse_single_example(value,features={'X': tf.FixedLenFeature([], dtype=tf.float32})

value='dataset1/a1.tfrecords'
qq=tf.parse_single_example(value,features={'X': tf.FixedLenFeature([], tf.float32)})



filename='dataset1/a1.tfrecords'
